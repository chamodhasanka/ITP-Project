...
export default function AllEmployee(){
    ...
    const deleteEmployee=(id) =>{
        axios.delete(`http://localhost:3000/employee/deleteemp/${id}`).then(()=>{
            swal({
                title: "Are you sure?",
    ...
    useEffect(() => {
        ...
        axios.get("http://localhost:3000/employee/allemp").then((res) => {
...
<br></br>         
   <table class="table table-bordered">
       ...
       <td> <a className="btn btn-warning" href={'update/' + (f.employeeID)}>Edit
